...
parser.add_argument('--content_image_path', default="./demo_images_less/in5.content.png")
parser.add_argument('--content_seg_path', default='./results/in5.content_seg.pgm')
parser.add_argument('--style_image_path', default='./demo_images_less/in5.style.png')
parser.add_argument('--style_seg_path', default='./results/in5.style_seg.pgm')
parser.add_argument('--output_image_path', default='./results/in5.with_auto_segmentation.png')
